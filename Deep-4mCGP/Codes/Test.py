...
data = np.array(pd.read_csv('/content/gdrive/MyDrive/Fusion-GP-ind.csv')) #testing set
    
X1 = data[0:200, 1:] #200 is the number of positive samples in testing set, '1' is the label of positive sample
Y1 = data[0:200, 0] #'0' is the label of negative sample
X2 = data[200:, 1:]
Y2 = data[200:, 0]
...
model_name = ('/content/gdrive/MyDrive/hasan/GP50_model/saved_model.pb') #load model generated by Deep-4mCGP.ipynb
model_back = load_model(model_name, 
                        custom_objects={'precision': precision,'recall':recall,'f1':f1,'TP':TP,'FN':FN,'TN':TN,'FP':FP})
# model = load_model('/content/gdrive/MyDrive/hasan/GP50_model/saved_model.pb')
...
fw = open("//content/drive/MyDrive/hasan/Result.txt", "w") #define result outputFile 
